        ...
        <template v-if="selected">
            <div class="d-flex mb-3">
                <div class="flex-grow-1">
                    <h4>Lot {{selected.lot}}</h4>
                    <div class="hstack gap-3 flex-wrap">
                        <div class="text-muted">Block : <span class="text-body fw-medium">{{selected.block}}</span></div>
                        <div class="vr"></div>
                        <div class="text-muted">Section : <span class="text-body fw-medium">{{selected.section}}</span></div>
                        <div class="vr"></div>
                        <div class="text-muted">Area : <span class="text-body fw-medium">{{selected.area}}</span></div>
                        <div class="vr"></div>
                        <div class="text-muted">Phase : <span class="text-body fw-medium">{{selected.phase}}</span></div>
                    </div>
                </div>
            ...
            <hr class="text-muted"/>
            <Map @set="handleCoordinates" :coordinate="selected.coordinate" ref="map" class="leaflet-map"/>
        </template>
